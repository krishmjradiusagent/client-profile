  ...
  ),
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-transparent bg-[linear-gradient(#ffffff,#ffffff),linear-gradient(90deg,var(--color-1),var(--color-5),var(--color-3),var(--color-4),var(--color-2))] bg-[length:auto,200%] text-accent-foreground [background-clip:padding-box,border-box] [background-origin:border-box] before:absolute before:bottom-[-10%] before:left-1/2 before:z-0 before:h-[10%] before:w-2/5 before:-translate-x-1/2 before:animate-rainbow before:bg-[linear-gradient(90deg,var(--color-1),var(--color-5),var(--color-3),var(--color-4),var(--color-2))] before:bg-[length:200%] before:[filter:blur(0.4rem)]",
      },
      size: {
        default: "h-10 px-3",
        sm: "h-8 px-3 text-xs",
